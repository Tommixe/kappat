...
To create to vm template you have to option:
1. Using packer in the packer-proxmox-templates folder in this repo
2. Manually using the steps described here below:
